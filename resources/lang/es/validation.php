...
return [
    ...
    */
    ...
    'custom' => [
        'hora_salida_lunes' => [
            'after' => 'El campo hora salida lunes debe ser una hora posterior a hora entrada lunes.',
        ],
        'hora_salida_martes' => [
            'after' => 'El campo hora salida martes debe ser una hora posterior a hora entrada martes.',
        ],
        'hora_salida_miercoles' => [
            'after' => 'El campo hora salida miercoles debe ser una hora posterior a hora entrada miercoles.',
        ],
        'hora_salida_jueves' => [
            'after' => 'El campo hora salida jueves debe ser una hora posterior a hora entrada jueves.',
        ],
        'hora_salida_viernes' => [
            'after' => 'El campo hora salida viernes debe ser una hora posterior a hora entrada viernes.',
        ],
        'hora_salida_sabado' => [
            'after' => 'El campo hora salida sabado debe ser una hora posterior a hora entrada sabado.',
        ],
        'hora_salida_domingo' => [
